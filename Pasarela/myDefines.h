...
#define HTTP_OTA_ADDRESS      F("XXX.XXX.XXX.XXX")         // Address of OTA update server
...
//#define OTA_URL             "https://xxxxxxxxxxxxx/esp8266-ota-update"
//#define OTA_FINGERPRINT     "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx" 
//#define HTTP_OTA_VERSION      String(__FILE__).substring(String(__FILE__).lastIndexOf('\\')+1) + ".nodemcu" 
